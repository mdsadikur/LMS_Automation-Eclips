...
public class POM_QuizEnroll {
	...
	public POM_QuizEnroll(WebDriver driver) {
	...
	public void enrollQUiz() throws InterruptedException {
		...
		System.out.println("Entered at Quiz Enroll");
		...
		System.out.println("Checkout from Quiz Enroll");
	}
	
	public void quizView(int i) throws InterruptedException {
...
//			Thread.sleep(1000);
	...
	public void quizPurchase(int i) throws InterruptedException {
...
//		cart.click();
		...
		d.get("https://spondan.com/spn19/production/qa/quizzes");
